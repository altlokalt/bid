    ...
    <>
      <div className="bg-black_900 flex flex-col font-montserrat items-center justify-end mx-[auto] w-[100%]">
        ...
        <div className="md:h-[5022px] h-[5062px] md:px-[20px] relative w-[100%]">
                ...
                >
                  <div className="flex flex-1 flex-col gap-[40px] items-start justify-start max-w-[1520px] w-[100%]">
                    ...
                    <div className="flex md:flex-col flex-row md:gap-[40px] gap-[80px] items-center justify-start w-[100%]">
                      <div className="flex md:flex-col gap-[40px] grid-cols-4 items-start justify-start w-[100%]">
                  ...
                  <div className="flex flex-1 flex-col gap-[40px] items-start justify-start max-w-[1520px] w-[100%]">
                    ...
                    <div className="flex flex-col sm:flex-row md:gap-[40px] gap-[80px] items-center justify-start w-[100%]">
          ...
          <div className="absolute bg-black_900_5b flex inset-x-[0] items-center justify-start mx-[auto] p-[67px] sm:px-[20px] md:px-[40px] top-[0] w-[100%]">
            <div className="flex items-center justify-start md:w-[100%] w-[32%]">
              <div className="bg-black_900 flex flex-col gap-[24px] items-start justify-start pb-[32px] pt-[24px] sm:px-[20px] px-[24px] rounded-[12px] sm:w-[100%] w-[480px]">
                ...
                <div className="flex flex-col gap-[40px] items-center justify-start w-[100%]">
                  <Img
                    ...
                    alt="image Thirteen"
                  />
                  <div className="bg-gray_900 flex flex-col gap-[24px] items-start justify-start p-[24px] sm:px-[20px] rounded-[12px] w-[100%]">
                    <div className="flex flex-col gap-[8px] items-start justify-start w-[100%]">
                      <div className="flex flex-row gap-[8px] items-start justify-between w-[100%]">
                        <Text
                          className="font-normal not-italic text-gray_600 text-left w-[auto]"
