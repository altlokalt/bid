  ...
  return (
    <>
      <div className="bg-black_900 flex flex-col font-montserrat items-center justify-end mx-[auto] w-[100%]">
              ...
              <ul className="flex sm:flex-col flex-row gap-[8px] sm:hidden items-start justify-start w-[auto] common-row-list">
                <li className="sm:w-[100%] sm:my-[10px] w-[10%]">
                  <Button className="flex h-[40px] items-center justify-center p-[8px] rounded-[12px]">
                    <Img
                      src="images/img_minimize_12.svg"
                      className=""
                      alt="minimize"
                    />
                  </Button>
        ...
        <div className="md:h-[5119px] h-[5158px] md:px-[20px] relative w-[100%]">
              ...
              <div className="flex flex-col items-center justify-start md:w-[100%] w-[91%]">
                <div className="flex md:flex-col flex-row md:gap-[40px] items-center justify-between w-[100%]">
                  <div className="flex md:flex-1 flex-col gap-[40px] items-center justify-start md:w-[100%] w-[49%]">
                    <div className="flex flex-col gap-[16px] items-center justify-start md:w-[100%] w-[76%]">
                      <div className="flex sm:h-[auto] items-start justify-start sm:w-[100%] w-[560px]">
                ...
                <div className="flex flex-col gap-[40px] items-start justify-start mt-[80px] md:w-[100%] w-[auto]">
                ...
                <List
                  className="flex-col md:gap-[40px] gap-[80px] grid items-center mt-[80px] w-[100%]"
                  orientation="vertical"
                >
          ...
          <div className="absolute bg-black_900_5b flex inset-x-[0] items-center justify-end mx-[auto] p-[207px] sm:px-[20px] md:px-[40px] top-[0] w-[100%]">
              ...
              <div className="bg-black_900 flex flex-col gap-[24px] items-start justify-start pb-[32px] pt-[24px] sm:px-[20px] px-[24px] sm:w-[100%] w-[480px]">
                ...
                <div className="flex flex-col gap-[40px] items-center justify-start w-[100%]">
                  <div className="flex flex-row gap-[16px] items-start justify-start w-[100%]">
                    <div className="bg-gray_903 flex-1 h-[59px] w-[59px]"></div>
                    <div className="bg-gray_903 flex-1 h-[59px] w-[59px]"></div>
                    <div className="bg-gray_903 flex-1 h-[59px] w-[59px]"></div>
                    <div className="bg-gray_903 flex-1 h-[59px] w-[59px]"></div>
                    <div className="bg-gray_903 flex-1 h-[59px] w-[59px]"></div>
                  </div>
                  <div className="bg-gray_905 flex flex-col gap-[24px] items-start justify-start p-[24px] sm:px-[20px] w-[100%]">
                    <div className="flex flex-col gap-[8px] items-start justify-start w-[100%]">
                      <div className="flex flex-row gap-[8px] items-start justify-between w-[100%]">
                        <Text
                          className="font-normal not-italic text-gray_600 text-left w-[auto]"
                    ...
                    <div className="flex flex-col gap-[4px] items-start justify-start w-[100%]">
                      <div className="bg-gray_901 border-[1px] border-lime_A400 border-solid flex flex-row gap-[8px] items-start justify-start p-[16px] w-[100%]">
                        <div className="flex flex-1 flex-col h-[100%] items-center justify-start w-[100%]">
                          <Text
                            className="font-semibold text-left text-white_A700 w-[auto]"
                            as="h6"
                            variant="h6"
