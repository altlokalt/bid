...
const DetailsInfoPage = () => {
  ...
  return (
    <>
      <div className="bg-black_900 flex font-montserrat items-center justify-end mx-[auto] w-[100%]">
        <div className="flex flex-col items-center justify-end w-[100%]">
                ...
                <ul className="flex sm:flex-col flex-row gap-[8px] sm:hidden items-start justify-start w-[auto] common-row-list">
                  <li className="sm:w-[100%] sm:my-[10px] w-[10%]">
                    <Button className="flex h-[40px] items-center justify-center p-[8px] rounded-[12px]">
                      <Img
                        src="images/img_minimize_11.svg"
                        className=""
                        alt="minimize"
                      />
                    </Button>
          ...
          <div className="flex md:flex-col flex-row gap-[40px] items-center justify-start max-w-[1520px] mt-[38px] mx-[auto] md:px-[20px] w-[100%]">
            <div className="flex md:flex-1 flex-col md:flex-row gap-[40px] items-center justify-start md:w-[100%] w-[49%]">
              <div className="flex flex-col gap-[16px] items-start justify-start sm:w-[100%] w-[auto]">
                ...
                <div className="flex flex-row gap-[16px] h-[80px] md:h-[auto] items-start justify-start sm:w-[100%] w-[560px]">
            ...
            <div className="flex md:flex-1 flex-col gap-[40px] sm:hidden items-center justify-start md:w-[100%] w-[49%]">
          ...
          <div className="flex flex-col gap-[40px] items-start justify-start max-w-[1520px] mt-[80px] mx-[auto] md:px-[20px] w-[100%]">
            ...
            <div className="bg-gray_900 flex flex-col md:flex-row gap-[40px] sm:hidden items-center justify-start max-w-[1520px] pb-[40px] pt-[24px] sm:px-[20px] px-[24px] w-[100%]">
