    ...
    <>
      <div className="bg-black_900 flex flex-col font-montserrat items-center justify-end mx-[auto] w-[100%]">
        ...
        <div className="md:h-[5022px] h-[5062px] md:px-[20px] relative w-[100%]">
            ...
            <div className="flex flex-col gap-[180px] md:gap-[40px] items-center justify-start w-[100%]">
              <div className="flex flex-col md:gap-[40px] gap-[80px] items-center justify-start md:w-[100%] w-[91%]">
                <div className="flex md:flex-col flex-row md:gap-[40px] items-center justify-between w-[100%]">
                  ...
                  <div className="flex md:flex-1 flex-col gap-[40px] items-center justify-start md:w-[100%] w-[49%]">
                    ...
                    <div className="flex flex-col gap-[24px] h-[594px] md:h-[auto] items-start justify-start max-w-[740px] w-[100%]">
                      ...
                      <div className="bg-gray_900 flex flex-col gap-[24px] h-[100%] sm:hidden items-start justify-between p-[24px] sm:px-[20px] w-[100%]">
                        <List
                ...
                <div className="flex flex-col gap-[40px] items-start justify-start md:w-[100%] w-[auto]">
                  ...
                  <div className="bg-gray_900 flex flex-col gap-[40px] sm:hidden items-center justify-start max-w-[1520px] pb-[40px] pt-[24px] sm:px-[20px] px-[24px] w-[100%]">
              ...
              <div className="flex flex-col items-center justify-start w-[100%]">
                ...
                <div className="bg-black_900 flex sm:hidden items-center justify-end p-[40px] sm:px-[20px] w-[100%]">
          ...
          <div className="absolute bg-black_900_5b flex inset-x-[0] items-center justify-start mx-[auto] p-[315px] sm:px-[20px] md:px-[40px] top-[0] w-[100%]">
            <div className="flex items-center justify-start md:w-[100%] w-[46%]">
              <div className="bg-black_900 flex flex-col gap-[24px] items-start justify-start pb-[32px] pt-[24px] sm:px-[20px] px-[24px] sm:w-[100%] w-[480px]">
                <div className="h-[124px] relative w-[100%]">
                      ...
                      <div className="flex items-start justify-start w-[100%]">
                        <div className="bg-gray_901 flex sm:flex-col flex-row gap-[8px] items-start justify-start px-[16px] py-[20px] w-[100%]">
                          <Text
                            ...
                            variant="h6"
                          >
                            0xhg34293y808f3CC1420803D063b8077Fd350b3...
                          </Text>
                          <div className="flex flex-row gap-[8px] items-center justify-start w-[auto]">
                            <Img
                  ...
                  <div className="absolute flex flex-col items-center justify-start right-[5%] top-[19%] w-[auto]">
                    <div className="bg-bluegray_900 flex items-start justify-start p-[16px] rounded-[8px] w-[auto]">
                      <Text
                ...
                >
                  <span className="text-gray_600 text-[14px] font-montserrat">
                    The contract above is{" "}
                  </span>
                  <span className="text-amber_A400 text-[14px] font-montserrat font-semibold">
                    not verified yet
                  </span>
                  <span className="text-gray_600 text-[14px] font-montserrat">
                    . Please make sure it is the correct one for{" "}
                  </span>
                  <span className="text-white_A700 text-[14px] font-montserrat font-semibold">
                    Doodle Apes
                  </span>
                  <span className="text-black_900 text-[14px] font-montserrat">
                    {" "}
                  </span>
                  <span className="text-gray_600 text-[14px] font-montserrat">
                    before you proceed.
